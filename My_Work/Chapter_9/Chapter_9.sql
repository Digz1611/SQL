...
FROM 'C:\Code_College\Java_Bootcamp\SQL\My_Work\Chapter_9\MPI_Directory_by_Establishment_Name.csv'
...
COPY state_regions
FROM 'C:\Code_College\Java_Bootcamp\SQL\My_Work\Chapter_9\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
