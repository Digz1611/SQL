...
FROM 'C:\Code_College\Java_Bootcamp\SQL\My_Work\Chapter_10\acs_2011_2015_stats.csv'
...
FROM 'C:\Code_College\Java_Bootcamp\SQL\My_Work\Chapter_10\fbi_crime_data_2015.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
